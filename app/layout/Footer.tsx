  ...
  return (
    <footer className="bg-zinc-950 text-zinc-300 border-t border-zinc-800 font-sans">
      <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
        {/* Top Section: Branding, Links, Contact */}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-xs text-zinc-500 space-y-4 md:space-y-0">
